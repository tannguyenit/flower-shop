...
<?php
	...
	if(isset($_POST["submit"])){
		$ten=$_POST["ten"];
		$query="INSERT INTO theloai(Tentheloai) VALUES('{$ten}')";
		$result=$mysqli->query($query);
		if($result){
			header("location:addCat.php?true=tin đã được thêm vào danh sách");
		}
		else{
			header("location:addCat.php?true=có lỗi xảy ra trong quá trình thêm tin");
		}
	}
?>
<!-- Form elements -->    
<div class="grid_12">
	...
	<div class="module">
		 <h2><span>Thêm danh mục hoa</span></h2>
