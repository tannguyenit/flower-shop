...
<?php
	...
	$querytsd="SELECT COUNT(id_nhom) AS tongsodong FROM nhom";
	...
	$query="SELECT * FROM nhom LIMIT {$off_set},{$row_count}";
...
<div class="bottom-spacing">
	...
	<div class="float-left">
		<a href="addColor.php" class="button">
			<span>Thêm danh mục màu<img src="/banhoa/templates/admin/images/plus-small.gif" alt="Thêm tin"></span>
		</a>
	</div>
	<div class="clear"></div>
</div>
...
<div class="grid_12">
	<!-- Example table -->
	<div class="module">
		<h2><span>Danh sách danh mục màu</span></h2>
			...
			<table id="myTable" class="tablesorter">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="editColor.php?edit=<?php echo $id?>">Sửa <img src="/banhoa/templates/admin/images/pencil.gif" alt="edit" /></a>
							<a href="delColor.php?delete=<?php echo $id?>">Xóa <img src="/banhoa/templates/admin/images/bin.gif" width="16" height="16" alt="delete" /></a>
						</td>
					</tr>
					<?php }?>
				</tbody>
		 ...
		 <div class="pagination">           
					<div class="numbers">
						...
						<?php
							for($i=1;$i<=$sotrang;$i++){
						?>
						<a href="indexColor.php?current_page=<?php echo $i?>"><?php echo $i?></a> 
						<span>|</span> 
						<?php
							}
						?>
