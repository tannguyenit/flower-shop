...
<?php
	...
	if(isset($_GET["edit"])){
		...
		if(isset($_POST["sua"])){
			$ten=$_POST["ten"];
			$query="UPDATE theloai set Tentheloai='{$ten}' WHERE id_theloai='{$id}'";
			$result=$mysqli->query($query);
			if($result){
				header("location:indexCat.php?edit=tin đã được sửa ");
			}
			else{
				header("location:indexCat.php?edit=có lỗi xảy ra trong quá trình sửa tin");
			}
		}
	}
?>
...
<div class="grid_12">
	...
	<div class="module">
		 <h2><span>Sửa danh mục hoa</span></h2>
